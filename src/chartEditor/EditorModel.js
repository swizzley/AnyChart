...
anychart.chartEditorModule.EditorModel.ChartTypes = {
  ...
  'line': {
    ...
    'dataSetCtor': 'set',
    'panelsExcludes': ['colorScale', 'colorRange', 'radarPolarAxes', 'circularGaugeAxes', 'circularRanges', 'scaleBars', 'pointers'],
    'filters': ['common']
  },
  'area': {
    'value': 'area',
  ...
  'pie': {
    ...
    'dataSetCtor': 'set',
    'singleSeries': true,
    'panelsExcludes': ['series', 'grids', 'cartesianAxes', 'colorScale', 'colorRange', 'radarPolarAxes', 'circularGaugeAxes', 'circularRanges', 'scaleBars', 'pointers'],
    'filters': ['common']
  },
  'funnel': {
    'value': 'funnel',
  ...
  'map': {
    ...
    'dataSetCtor': 'set',
    'panelsExcludes': ['grids', 'cartesianAxes', 'colorScale', 'radarPolarAxes', 'circularGaugeAxes', 'circularRanges', 'scaleBars', 'pointers'],
  ...
  'stock': {
    ...
    'dataSetCtor': 'table',
    'panelsExcludes': ['dataLabels', 'cartesianAxes', 'colorScale', 'colorRange', 'radarPolarAxes', 'circularGaugeAxes', 'circularRanges', 'scaleBars', 'pointers'],
  ...
  'polar': {
    ...
    'dataSetCtor': 'set',
    'panelsExcludes': ['colorScale', 'colorRange', 'cartesianAxes', 'circularGaugeAxes', 'circularRanges', 'scaleBars', 'pointers'],
    'filters': ['common']
  },
  'radar': {
    'value': 'radar',
  ...
  'mekko': {
    ...
    'series': ['mekko'],
    'dataSetCtor': 'set',
    'panelsExcludes': ['grids', 'colorScale', 'colorRange', 'radarPolarAxes', 'circularGaugeAxes', 'circularRanges', 'scaleBars', 'pointers'],
    'filters': ['common']
  },
  'barmekko': {
    'value': 'barmekko',
  ...
  'heatMap': {
    ...
    'dataSetCtor': 'set',
    'singleSeries': true,
    'panelsExcludes': ['series', 'colorRange', 'radarPolarAxes', 'circularGaugeAxes', 'circularRanges', 'scaleBars', 'pointers'],
  ...
  'treeMap': {
    ...
    'dataSetCtor': 'tree',
    'singleSeries': true,
    'panelsExcludes': ['series', 'grids', 'cartesianAxes', 'radarPolarAxes', 'circularGaugeAxes', 'circularRanges', 'scaleBars', 'pointers'],
    'settingsExcludes': ['palette()', 'animation().enabled()'],
    'filters': ['common']
  },
  'gauges.circular': {
  ...
  'gauges.linear.led': {
    ...
    'panelsExcludes': ['dataLabels', 'series', 'grids', 'colorScale', 'colorRange', 'circularRanges',
      'cartesianAxes', 'radarPolarAxes', 'circularGaugeAxes'
    ],
    'settingsExcludes': ['palette()'],
    'filters': ['common', 'gauges']
  }
