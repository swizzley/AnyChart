goog.provide('anychart.chartEditorModule.controls.select.Align');
 ...
 */
anychart.chartEditorModule.controls.select.Align = function(opt_inverse) {
  anychart.chartEditorModule.controls.select.Align.base(this, 'constructor');
...
goog.inherits(anychart.chartEditorModule.controls.select.Align, anychart.chartEditorModule.controls.select.DataFieldSelect);
 ...
 * @private
 */
anychart.chartEditorModule.controls.select.Align.prototype.orientation_ = '';
 ...
 * @private
 */
anychart.chartEditorModule.controls.select.Align.prototype.orientationKey_ = 'orientation';


/** @param {string|Array.<string>} value */
anychart.chartEditorModule.controls.select.Align.prototype.setOrientationKey = function(value) {
 ...
 */
anychart.chartEditorModule.controls.select.Align.prototype.updateIcons = function(orientationValue) {
