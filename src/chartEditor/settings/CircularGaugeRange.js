...
goog.inherits(anychart.chartEditorModule.settings.CircularRange, anychart.chartEditorModule.SettingsPanelIndexed);
...
anychart.chartEditorModule.settings.CircularRange.prototype.createDom = function() {
  ...
  wrapper.addChild(axisIndex, true);
  ...
  wrapper.addChildControl(position);
  ...
  wrapper.addChildControl(fromlLC);
  ...
  wrapper.addChildControl(startSizeLC);
  ...
  wrapper.addChildControl(endSizeLC);
