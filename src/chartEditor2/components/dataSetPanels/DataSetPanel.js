...
anychart.chartEditor2Module.DataSetPanel.prototype.createDom = function() {
  anychart.chartEditor2Module.DataSetPanel.base(this, 'createDom');
...
/** @inheritDoc */
anychart.chartEditor2Module.DataSetPanel.prototype.disposeInternal = function() {
  this.menu_.dispose();
  this.menu_ = null;
  ...
  anychart.chartEditor2Module.DataSetPanel.base(this, 'disposeInternal');
};
