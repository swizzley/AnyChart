...
anychart.chartEditor2Module.steps.PrepareData.prototype.createDom = function() {
  anychart.chartEditor2Module.steps.PrepareData.base(this, 'createDom');
  ...
  // user data section
  this.userData_ = new anychart.chartEditor2Module.UserData([
    {
...
/** @override */
anychart.chartEditor2Module.steps.PrepareData.prototype.enterDocument = function() {
  anychart.chartEditor2Module.steps.PrepareData.base(this, 'enterDocument');

  this.getHandler().listen(this.userData_, anychart.chartEditor2Module.UserData.EventType.ACTION, function(e) {
...
anychart.chartEditor2Module.steps.PrepareData.prototype.addLoadedData = function(data, dataType) {
  ...
  if (result) {
    var type = anychart.chartEditor2Module.EditorModel.DataType.CUSTOM;
