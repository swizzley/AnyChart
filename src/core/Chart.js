 ...
 * @return {boolean}
 */
anychart.core.Chart.prototype.supportsOutliers = function() {
  return false;
};
 ...
 * @return {boolean}
 */
anychart.core.Chart.prototype.supportsMarkers = function() {
  return false;
};
 ...
 * @return {boolean}
 */
anychart.core.Chart.prototype.supportsLabels = function() {
  return false;
};
...
anychart.core.Chart.prototype.handleMouseEvent = function(event) {
  ...
  if (anychart.utils.instanceOf(event['target'], anychart.core.ui.LabelsFactory)
      || anychart.utils.instanceOf(event['target'], anychart.core.utils.MarkersFactory)) {
...
anychart.core.Chart.prototype.onMouseDown = function(event) {
  ...
  var isMarkersFactory = anychart.utils.instanceOf(event['target'], anychart.core.utils.MarkersFactory);
